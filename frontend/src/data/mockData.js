// Mock data matching the ThalNet prototype exactly.
// These are used as default/fallback values when API returns nothing.

export const bridgeDonors = [
  ...
  { id:"d4", name:"Anjali Nair",   group:"O+", km:2.4,  status:"resting",   note:"Eligible again Jun 30",        lastDonated:"May 9",  responsiveness:0.90, churn:0.10 },
  { id:"d5", name:"Karthik Varma", group:"O+", km:9.6,  status:"awaiting",  note:"Outreach sent · awaiting reply",lastDonated:"Jan 30", responsiveness:0.64, churn:0.34 },
  ...
  { id:"d8", name:"Meghana Rao",   group:"O+", km:4.5,  status:"awaiting",  note:"Outreach sent · Telugu",       lastDonated:"Feb 2",  responsiveness:0.71, churn:0.27 },
...
export const patient = {
  id:"p_anaya", name:"Anaya Kulkarni", age:9, group:"O+",
  city:"Secunderabad, Telangana", hospital:"Center for Thalassemia & Blood Disorders",
  diagnosis:"Beta Thalassemia Major", cadence:22,
  nextTransfusion:"Jun 18, 2026", daysToTransfusion:4,
  lifetimeTransfusions:168, unitsThisCycle:2,
  bridge:{ integrity:78, health:"at-risk", target:9, confirmed:2, scheduled:1, contacted:2, resting:2, lapsed:1, empty:1 },
  timeline:[
...
export const me = {
  id:"d_arjun", name:"Arjun Mehta", group:"O+", city:"Begumpet, Hyderabad",
  eligibleInDays:12, eligibleDate:"Jun 18, 2026", lastDonated:"Apr 5, 2026",
  cycleDays:90, daysSince:78, unitsDonated:11, patientsHelped:6, firstDonation:"2023",
  match:{ patientInitial:"A", group:"O+", km:4, neededDate:"Jun 18, 2026", hospital:"Center for Thalassemia & Blood Disorders", area:"Secunderabad" },
  history:[
...
export const adminStats = {
  activeRequests:7, bridgesTotal:47, bridgesFull:38, bridgesAtRisk:6, bridgesBroken:3,
  donorPool:4446, donorsActive:1284, confirmedToday:12, outreachToday:34, escalations:2,
};
...
export const agentFeed = [
  { t:"09:14", ok:true,  msg:"Bridge b1 (Anaya K.) — Ravi Teja confirmed Jun 18. Slot locked." },
  { t:"09:12", ok:true,  msg:"Outreach sent to Karthik Varma (O+, 9km) in Telugu via WhatsApp." },
  { t:"08:58", ok:false, msg:"Sai Krishna — 3rd no-reply. Flagged for DND. Replacement sourcing." },
  { t:"08:40", ok:true,  msg:"Bridge b3 (Fatima R.) — emergency rank complete. 6 candidates found." },
  { t:"08:31", ok:true,  msg:"Meghana Rao eligibility confirmed. Slot pre-allocated Jun 19." },
  { t:"07:55", ok:true,  msg:"Supply check: O+ Secunderabad 2.1d coverage. Pre-mobilising 14 donors." },
];

export const supply = {
  nationalBanks:3863, stockRows:44675,
  regional:[
    { group:"O+",  units:847, status:"ok"       },
    { group:"O-",  units:123, status:"watch"    },
    { group:"A+",  units:612, status:"ok"       },
    { group:"A-",  units:54,  status:"low"      },
    { group:"B+",  units:431, status:"ok"       },
    { group:"B-",  units:38,  status:"critical" },
    { group:"AB+", units:229, status:"ok"       },
    { group:"AB-", units:19,  status:"critical" },
  ],
  prediction:{ group:"O-", area:"Hyderabad", window:"4 days", note:"7 bridges depend on O- stock" },
  banks:[
    { name:"Aarohi Blood Center",     area:"Ameerpet",    km:2.1,  open:true,  units:312 },
    { name:"Red Cross Blood Bank",    area:"Abids",       km:4.8,  open:true,  units:189 },
    { name:"NTR Trust Blood Bank",    area:"Nampally",    km:5.2,  open:false, units:0   },
    { name:"Care Hospital Blood Bank",area:"Banjara Hills",km:7.6, open:true,  units:204 },
  ],
};
